...
function show_crunchlr_facebook_page_plugin_likebox_widget($args)
{
    ...
    if ($sponser == 1) {
        ...
        $sponserlink_profile = '<div align="left">- <a href="http://crunchlr.com/facebook-page-plugin-likebox-for-wordpress/" title="Facebook Page Plugin by Smashify.co" target="_blank"> <font size="1">' . 'Facebook Page Plugin by Smashify' . '</font></a></div>';
    }
