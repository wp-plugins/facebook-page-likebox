...
Plugin URI: https://sparklr.io/facebook-page-plugin-likebox-for-wordpress/
Description: THE Simplest way to bring Facebook Page Plugin to WordPress with lot more Options
Version: 1.4
Author: Sparklr
Author URI: https://sparklr.io
*/

/*
    Copyright (C) 2015 Sparklr.io
...
function show_smashify_facebook_page_plugin_likebox_widget($args)
{
    ...
    if ($sponser == 1) {
        ...
        $sponserlink_profile = '<div align="left">- <a href="https://sparklr.io/facebook-page-plugin-likebox-for-wordpress/" title="Facebook Page Plugin by Smashr.org" target="_blank"> <font size="1">' . 'Facebook Page Plugin by Crunchlr' . '</font></a></div>';
    }
